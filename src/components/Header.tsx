...
import { ChevronDown, Calculator, Wheat, Sprout, Milestone, Settings } from "lucide-react";
    ...
    <header className="sticky top-0 z-50 w-full border-b border-neutral-200 bg-white/80 backdrop-blur-md">
      <div className="container mx-auto flex h-20 max-w-7xl items-center justify-between px-4 sm:px-6">
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-neutral-600">
          ...
          >
            <button 
              className="flex items-center gap-1 hover:text-emerald-800 transition-colors focus:outline-none py-2"
            ...
            {/* Menu Dropdown com efeito Premium HSL Emerald */}
            {dropdownOpen && (
              <div className="absolute left-0 mt-0 w-80 rounded-2xl border border-neutral-200 bg-white p-4 shadow-xl animate-in fade-in slide-in-from-top-2 duration-200">
                <div className="space-y-1">
                  ...
                  {/* Placeholders indicando expansão futura */}
